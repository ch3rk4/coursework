...
def test_investment_bank_basic() -> None:
    ...
    transactions = [
        ...
        {"Дата операции": "31.01.2024 16:41:00", "Сумма операции": 45.5},
    ]
...
def test_investment_bank_different_month() -> None:
    ...
    transactions = [
        ...
        {"Дата операции": "16.02.2024 13:21:00", "Сумма операции": 45.5},
    ]
    result = investment_bank("2024-01", transactions, 50)
...
def test_investment_bank_negative_amounts() -> None:
    ...
    transactions = [
        {"Дата операции": "15.01.2024 15:11:00", "Сумма операции": 1712.0},
        {"Дата операции": "16.01.2024 15:11:00", "Сумма операции": -45.5},
    ]
    result = investment_bank("2024-01", transactions, 50)
...
def test_investment_bank_realistic_data() -> None:
    ...
    transactions = [
        {"Дата операции": "15.01.2024 15:11:00", "Сумма операции": 1712.0},
        {"Дата операции": "16.01.2024 15:12:00", "Сумма операции": 999.99},
        {"Дата операции": "01.02.2024 15:13:00", "Сумма операции": 45.5},  # другой месяц
        {"Дата операции": "20.01.2024 15:14:00", "Сумма операции": -150.0},  # отрицательная сумма
        {"Дата операции": "25.01.2024 15:15:00", "Сумма операции": 2499.50},
    ]
...
def test_investment_bank_precision() -> None:
    ...
    transactions = [
        ...
        {"Дата операции": "16.01.2024 15:11:00", "Сумма операции": 45.01},
    ]
    result = investment_bank("2024-01", transactions, 50)
